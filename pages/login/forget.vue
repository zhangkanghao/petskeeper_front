	...
	<view class="forget">
		...
		<view class="content">
			...
			<view class="main">
				...
				<wInput v-model="verCode" type="number" maxlength="4" placeholder="验证码" isShowCode codeText="获取重置码" setTime="60"
	...
	export default {
		...
		methods: {
			...
			startRePass() {
				...
				uni.request({
					url: _this.apiUrl+'/user/resetpwd',
					method: 'POST',
					header:{
