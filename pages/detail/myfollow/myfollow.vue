<template>
	<view class="content1">
		...
		<view class="example-body">
			<uni-nav-bar :fixed="true" color="#333333" background-color="#FFFFFF" title="我的关注" leftIcon="left-nav" @clickLeft="cancel"></uni-nav-bar>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			getInfos(){
				uni.request({
					url: this.apiUrl+'/follow/following?userId='+uni.getStorageSync('userId'),
					method: 'GET',
