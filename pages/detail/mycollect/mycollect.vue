<template>
	<view class="content">
		...
		<view class="example-body" style="border-bottom: #f1f1f1 3upx solid;">
			<uni-nav-bar :fixed="true" color="#333333"  leftIcon="left-nav" leftText="返回"  title="我的收藏" @clickLeft="cancel" ></uni-nav-bar>
		</view>
					...
					<view class="cu-card dynamic" >
						<view class="cu-item shadow">
							<view class="cu-list menu-avatar">
								<view class="cu-item">
									<image class="cu-avatar round lg" :src="apiUrl+'/user/profile/avatar?userId='+item.userId"></image>
